      ...
      <div class="col-md-12">
        <div class="card ">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">{{ __('Daftar Jabatan') }}</p>
            <a href="javascript:void(0)" class="d-sm-inline-block btn btn-sm btn-secondary shadow-sm" id="tombol-utama">
              <i class="material-icons">add</i>
            </a>
          </div>
          <div class="card-body ">              
            <table id="dt-jabatan" class="table table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Nama Jabatan</th>
...
<script>
  ...
  $(document).ready(function() {
    var table = $('#dt-jabatan').DataTable({
      responsive: true,
      processing: true,
      serverSide: true,
          ...
          submitHandler: function (form) {
              ...
              $.ajax({
                  ...
                  success: function (data) { //jika berhasil
                      ...
                      var oTable = $('#dt-jabatan').dataTable(); //inialisasi datatable
    ...
    $('#tombol-utama-hapus').click(function () {
      var url = "{{ route('jabatan.destroy', ":dataId") }}";
