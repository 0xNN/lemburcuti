@extends('layouts.app', ['activePage' => 'jurusan', 'titlePage' => __('Jurusan')])
      ...
      <div class="col-md-12">
        <div class="card ">
          <div class="card-header card-header-primary">
            <h4 class="card-title">{{ __('Jurusan') }}</h4>
            <p class="card-category">{{ __('Daftar Jurusan') }}</p>
            <a href="javascript:void(0)" class="d-sm-inline-block btn btn-sm btn-secondary shadow-sm" id="tombol-utama">
              <i class="material-icons">add</i>
            </a>
          </div>
          <div class="card-body ">              
            <table id="dt-jurusan" class="table table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Nama Jurusan</th>
...
<script>
  ...
  $(document).ready(function() {
    var table = $('#dt-jurusan').DataTable({
      responsive: true,
      processing: true,
      serverSide: true,
          ...
          submitHandler: function (form) {
              ...
              $.ajax({
                  ...
                  success: function (data) { //jika berhasil
                      ...
                      var oTable = $('#dt-jurusan').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function () {
      ...
      $.get('jurusan/' + data_id + '/edit', function (data) {
    ...
    $('#tombol-utama-hapus').click(function () {
      var url = "{{ route('jurusan.destroy', ":dataId") }}";
