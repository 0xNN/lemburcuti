@extends('layouts.app', ['activePage' => 'pendidikan', 'titlePage' => __('Pendidikan')])

@section('content')
@include('pendidikan.modal')
<div class="content">
      ...
      <div class="col-md-12">
        <div class="card ">
          <div class="card-header card-header-primary">
            <h4 class="card-title">{{ __('Pendidikan') }}</h4>
            <p class="card-category">{{ __('Daftar Pendidikan') }}</p>
            <a href="javascript:void(0)" class="d-sm-inline-block btn btn-sm btn-secondary shadow-sm" id="tombol-utama">
              <i class="material-icons">add</i>
            </a>
          </div>
          <div class="card-body ">              
            <table id="dt-pendidikan" class="table table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th>ID</th>
...
<script>
  ...
  $(document).ready(function() {
    var table = $('#dt-pendidikan').DataTable({
      responsive: true,
      processing: true,
      serverSide: true,
      ...
      $("#form-tambah-edit").validate({
          submitHandler: function (form) {
              ...
              $.ajax({
                  ...
                  url: "{{ route('pendidikan.store') }}", //url simpan data
                  ...
                  success: function (data) { //jika berhasil
                      ...
                      var oTable = $('#dt-pendidikan').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function () {
      ...
      $.get('pendidikan/' + data_id + '/edit', function (data) {
    ...
    $('#tombol-utama-hapus').click(function () {
      var url = "{{ route('pendidikan.destroy', ":dataId") }}";
      ...
      $.ajax({
        ...
        success: function (data) { //jika sukses
          setTimeout(function () {
            ...
            var oTable = $('#dt-pendidikan').dataTable();
            oTable.fnDraw(false); //reset datatable
          });
