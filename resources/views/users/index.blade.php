@extends('layouts.app', ['activePage' => 'register-user', 'titlePage' => __('Register User')])
      ...
      <div class="col-md-12">
        <div class="card ">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">{{ __('Daftar User') }}</p>
            <a href="javascript:void(0)" class="d-sm-inline-block btn btn-sm btn-secondary shadow-sm" id="tombol-utama">
              <i class="material-icons">add</i>
            </a>
          </div>
          <div class="card-body ">              
            <table id="dt-user" class="table table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Nama</th>
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (data) { //jika berhasil
                        ...
                        var oTable = $('#dt-user').dataTable(); //inialisasi datatable
